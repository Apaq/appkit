        ...
        <tr>
          <td>
            ...
            ${
              ...
              <br>
              <small>
                <xena-tooltip content="Use the kebab-case variation in your HTML">
  ...
  window.$docsify.plugins.push((hook, vm) => {
    hook.mounted(function () {
      getMetadata().then(metadata => {
        ...
        buttons.innerHTML = `
            <a class="repo-button repo-button--small repo-button--github" href="https://github.com/eg-brs/Xena.DesignSystem" rel="noopener" target="_blank">
          ...
          result += `
            <div class="component-header">
              ...
              <div class="component-header__info">
                <xena-label type="info">
                  Since ${tags.since || '?'}
                </xena-label>

                <xena-label type="${badgeType}" style="text-transform: capitalize;">
                  ${tags.status}
                </xena-label>
              </div>
            </div>
