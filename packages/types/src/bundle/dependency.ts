 ...
 * 
 * Remark: The dependencies will only be loaded for untrusted 
 * bundles as trusted bundles is expected to have its dependencies 
 * fulfilled by site loading the bundle.
 */
